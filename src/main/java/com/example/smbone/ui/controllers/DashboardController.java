...
public class DashboardController {
    ...
    @FXML
    private VBox cardSmartContract;
    @FXML
    private VBox cardSupplyChain;
    ...
    private void animateParticles() {
        ...
        Timeline timeline = new Timeline(
                ...
                new KeyFrame(Duration.seconds(0), new KeyValue(particle1.translateXProperty(), 500), new KeyValue(particle2.translateYProperty(), 250), new KeyValue(particle3.translateXProperty(), 0), new KeyValue(particle4.translateYProperty(), -350)),

                new KeyFrame(Duration.seconds(20), new KeyValue(particle1.translateXProperty(), 400), new KeyValue(particle2.translateYProperty(), 200), new KeyValue(particle3.translateXProperty(), 100), new KeyValue(particle4.translateYProperty(), -250)));
